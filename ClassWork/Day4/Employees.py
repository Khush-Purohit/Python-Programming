class Employee:
    def __init__(self, empid=100, name='aaa', basic=10000):
        ...
        def basic(self, value):
            if value < 0:
                raise ValueError('Basic cannot be negative')
            else:
                self._basic = value
        ...
        def __str__(self):
            return f'Employee details Id: {self._empid}, Name: {self._name}, Salary: {self._salary}'
...
class NewEmployee:
    ...
    def __init__(self, empid=100, name='aaa', basic=10000):
        ...
        def __str__(self):
            return f'Empoyee deatils Id: {self._empid}, Name: {self._name}, Salary: {self._salary}'
